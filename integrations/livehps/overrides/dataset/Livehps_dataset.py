# integrations/livehps/overrides/dataset/Livehps_dataset.py
import torch
import pickle
import numpy as np
import os
...
class Dataset(torch.utils.data.Dataset):
    def __init__(self,args,m):
        self.dataset = []
        self.type = type
        if m == 'e':  # there is no fm_test2.pkl in google drive
            data_info_path = './data/FreeMotion_Indoor/LiDAR_info/FM_Indoor_test.pkl'
        self.Train = m
